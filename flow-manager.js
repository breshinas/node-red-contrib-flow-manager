...
PRIVATERED.runtime.storage.saveFlows = async function newSaveFlows(data) {
    if(data.flows && data.flows.length) {
        ...
        // save node ordering file. Prettify file to make it comparable in git
        await fs.writeJson(directories.nodesOrderFilePath, orderedNodeIds, { spaces: 2 });
    ...
    async function refreshDirectories() {
        ...
        try {
            ...
            if(!flowManagerSettings.fileFormat) {
                ...
                flowManagerSettings.fileFormat = 'yaml';
            }
        }
